...
struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6989_atf = {
...
unsigned int consys_plt_coredump_setup_dynamic_remap_mt6989_atf(int conn_type, unsigned int idx,
