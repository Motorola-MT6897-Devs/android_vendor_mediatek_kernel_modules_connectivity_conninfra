 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
...
void consys_set_if_pinmux_mt6897_gen(unsigned int enable)
{
	...
	vir_addr_consys_gen_iocfg_rt_base =
		ioremap(CONSYS_GEN_IOCFG_RT_BASE_ADDR, 0xd0);
	...
	if (enable == 1) {
		...
		/* set pinmux driving to 001 setting */
			...
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_DRV_CFG3_OFFSET_ADDR, 0x49000, 0x1FF000);
		#endif
...
void consys_set_gpio_tcxo_mode_mt6897_gen(unsigned int tcxo_mode, unsigned int enable)
{
	...
	if (enable == 1) {
		/* set GPIO119 pinmux for TCXO mode (Aux6) */
		#ifndef CONFIG_FPGA_EARLY_PORTING
			if (tcxo_mode == 1) {
				CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
					CONSYS_GEN_GPIO_MODE14_OFFSET_ADDR, 0x60000000, 0x70000000);
			}
		#endif
	} else {
		/* set GPIO119 pinmux for TCXO mode (Aux0) */
		#ifndef CONFIG_FPGA_EARLY_PORTING
			if (tcxo_mode == 1) {
				CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
					CONSYS_GEN_GPIO_MODE14_OFFSET_ADDR, 0x0, 0x70000000);
			}
		#endif
	}
}
...
{
	int check = 0;
	mapped_addr vir_addr_consys_gen_ifrbus_ao_reg_base = NULL;
	...
	vir_addr_consys_gen_ifrbus_ao_reg_base =
		ioremap(CONSYS_GEN_IFRBUS_AO_REG_BASE_ADDR, 0x1CC);

	if (!vir_addr_consys_gen_ifrbus_ao_reg_base) {
		pr_notice("vir_addr_consys_gen_ifrbus_ao_reg_base(%x) ioremap fail\n",
			CONSYS_GEN_IFRBUS_AO_REG_BASE_ADDR);
		return -1;
	}
	...
	if (enable == 1) {
		...
		CONSYS_SET_BIT(vir_addr_consys_gen_ifrbus_ao_reg_base +
	...
	if (vir_addr_consys_gen_ifrbus_ao_reg_base)
		iounmap(vir_addr_consys_gen_ifrbus_ao_reg_base);
...
int connsys_mawd_mem_hw_ctrl_setting_mt6897_gen(void)
{
	...
	if (consys_get_adie_chipid_mt6897() == ADIE_6686) {
		...
		/* conn_mawd memory  hw control setting -> disable hw power dowm */
		CONSYS_REG_WRITE(CONN_RGU_ON_BASE +
			CONSYS_GEN_MAWD_MEM_HWCTL_PDN_OFFSET_ADDR, 0x0);

		/* conn_mawd memory  hw control setting -> disable hw sleep */
		CONSYS_REG_WRITE(CONN_RGU_ON_BASE +
			CONSYS_GEN_MAWD_MEM_HWCTL_SLP_OFFSET_ADDR, 0x0);

		/* conn_mawd memory  sw control setting -> enable sw power dowm */
		CONSYS_REG_WRITE(CONN_RGU_ON_BASE +
			CONSYS_GEN_MAWD_MEM_SWCTL_PDN_OFFSET_ADDR, 0x1F);

		/* conn_mawd memory  sw control setting -> enable sw sleep */
		CONSYS_REG_WRITE(CONN_RGU_ON_BASE +
			CONSYS_GEN_MAWD_MEM_SWCTL_SLP_OFFSET_ADDR, 0x0);
	}
