 ...
 * - [Posont] connsys_power_debug.xlsx (Modified date: 2022-12-19)
 * - [Pxxxxt]conn_infra_bus_debug_ctrl.xlsx (Modified date: 2022-12-07)
 */
...
mapped_addr vir_addr_consys_dbg_gen_srclkenrc_base_mt6897;
mapped_addr vir_addr_consys_dbg_gen_topckgen_base_mt6897;
mapped_addr vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897;
mapped_addr vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897;

void consys_debug_init_mt6897_debug_gen(void)
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6897
		= ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x77C);
	vir_addr_consys_dbg_gen_topckgen_base_mt6897
		= ioremap(CONSYS_DBG_GEN_TOPCKGEN_BASE_ADDR, 0xD0);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897
		= ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR, 0xBA4);
	vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_AXI_LAYER_BUS_BCRM_BASE_ADDR, 0xc);
	vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897
		= ioremap(CONSYS_DBG_GEN_IFRBUS_AO_REG_BASE_ADDR, 0xC);
}
...
void consys_debug_deinit_mt6897_debug_gen(void)
{
	...
	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897);

	if (vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897);

	if (vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897)
		iounmap(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897);
}
		...
		struct conn_debug_info_mt6897 *pdbg_level_0_info)
{
	...
	/* A27 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
		"A27", 0x10000000 + CONSYS_DBG_GEN_CLK_CFG_12_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_topckgen_base_mt6897 +
		...
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	...
	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xB8C));

	/* C17 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C17", 0x18050000 + 0xB90,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xB90));

	/* C18 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C18", 0x18050000 + 0xB94,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xB94));

	/* C19 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C19", 0x18050000 + 0xB98,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xB98));

	/* C20 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C20", 0x18050000 + 0xB9C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xB9C));

	/* C21 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C21", 0x18050000 + 0xBA0,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xBA0));

	/* C22 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"C22", 0x18050000 + 0xBA4,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6897 + 0xBA4));
		...
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	...
	if (!vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897 +
		...
		struct conn_debug_info_mt6897 *pdbg_level_0_info)
{
	...
	if (!vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897(%x) ioremap fail\n",
	...
	/* 9 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
		"9", 0x1002C000 + CONSYS_DBG_GEN_SLEEP_PROT_EN_W1S_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897 +
			CONSYS_DBG_GEN_SLEEP_PROT_EN_W1S_0_OFFSET_ADDR));

	/* 10 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
		"10", 0x1002C000 + CONSYS_DBG_GEN_SLEEP_PROT_RDY_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6897 +
